/**
  ...
  */
package github.zimoyin.bili.video.info.pojo.recommendation;
import github.zimoyin.bili.exception.CodeException;
import github.zimoyin.bili.video.info.VideoOnlinePopulation;
import github.zimoyin.bili.video.info.pojo.info.data.*;
import github.zimoyin.bili.video.info.pojo.info.data.staff.StaffRoot;
import github.zimoyin.bili.video.info.pojo.info.data.subtitle.Subtitle;
import github.zimoyin.bili.video.info.pojo.online.OnlinePopulationRootBean;
...
@lombok.Data
class Data0{
    private List<VideoHomeRecommendationRootBean.Data> item;
}